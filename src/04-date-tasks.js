...
function isLeapYear(date) {
  ...
  return year % 400 === 0 || (year % 4 === 0 && year % 100 !== 0) || false;
}
...
function timeSpanToString(startDate, endDate) {
  ...
  const seconds = Math.floor((diff - hours * 1000 * 3600 - minutes * 60 * 1000) / 1000);
  const ms = diff - seconds * 1000 - minutes * 1000 * 60 - hours * 1000 * 3600;
